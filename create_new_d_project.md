...
new_d_project.sh war_games_tic_tac_toe "tic-tac-toe game for 2 players, 1 player or 0 players"
```
...
So if you want to explore our **war_games_tic_tac_toe** game with File Explorer, enter this into File Explorer path box:  `\\wsl$\Ubuntu\home\bb\path\to\my\new\project\war_games_tic_tac_toe`
